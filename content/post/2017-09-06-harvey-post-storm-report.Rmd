...
summary: > 
  A look at the immediate preliminary reports from local National Weather Service offices regarding weather observations from Hurricane Harvey.
author: 'Tim Trice'
date: '2017-09-06'
...
# Source data saved to GH
# https://github.com/timtrice/datasets/tree/master/harvey-prelims

src_url <- "https://raw.githubusercontent.com/timtrice/datasets/master/harvey-prelims/"
...
# Read data
txt <- map(rpts, ~readLines(sprintf("%s%s", src_url, .x)))
```
