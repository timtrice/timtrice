...
You do not need a Linux system to run Docker; Windows and macOS are supported as well as several other platforms. Once you get into the docker application, the codes (to my knowledge) are the same.
...
Then, from your terminal or console, 
